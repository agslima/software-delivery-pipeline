...
PATIENT_EMAIL="${PATIENT_EMAIL:-john.smith@stayhealthy.test}"
PATIENT_PASSWORD="${PATIENT_PASSWORD:-DemoPass123!}"
DOCTOR_EMAIL="${DOCTOR_EMAIL:-dr.emily@stayhealthy.test}"
DOCTOR_PASSWORD="${DOCTOR_PASSWORD:-DemoPass123!}"
ADMIN_EMAIL="${ADMIN_EMAIL:-admin@stayhealthy.test}"
