...
describe('App Integration', () => {
  ...
  it('loads prescriptions after successful login', async () => {
    ...
    api.loginPatient.mockResolvedValue({
      ...
      user: { id: 'patient-1', email: 'john.smith@stayhealthy.test', role: 'patient', mfaEnabled: false },
    });
    ...
    // Perform Login
    await user.type(screen.getByLabelText(/email/i), 'john.smith@stayhealthy.test');
